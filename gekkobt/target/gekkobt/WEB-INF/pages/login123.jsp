	...
	<div>
		...
		<form action="login/email">
			<div class="window" id="janela1">
				...
				<br />
				<h5>Digite seu email abaixo para sua senha:</h5>
				<br /> <label class="label_1"
					style="float: left; position: relative; top: 8px;"> E-mail:</label>
				<input id="userEmail" name="userEmail" style="width: 300px;"
					type="text" MaxLength="40" size="60" />
				<div class="btn-fld" style="float: right">

					<input type="submit" class="btn btn-primary" value="Enviar" />


					<!-- <button id="logar" class="btn btn-primary"
